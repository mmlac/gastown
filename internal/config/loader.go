...
// resolveExecWrapper loads the exec_wrapper from rig settings and expands template variables.
...
// If ctx is zero-value, template expansion is skipped (backwards compatible).
